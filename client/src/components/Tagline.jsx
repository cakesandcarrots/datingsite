...
function Tagline() {
  ...
  return (
    <div className="pt-20 flex relative overflow-hidden">
      <div className="flex-1 ">
        <img className=" max-w-none lg:top-[5.5rem] lg:left-[5.5rem] relative h-32 xl:left-24 xl:top-24 z-10" src={leftheart} alt="" />
        <img className=" max-w-none  relative bottom-4 h-40" src={leftcloud} alt="" />
      </div>
      <div className="flex-4 flex flex-col items-center">
        <div className="font-truenorg text-6xl font-bold">
